...
<body>
    ...
    <main>
        <div>
            <h1>hello i'm</h1>
            <a href="" class="typewrite" data-period="2000" data-type='[ " tiffany pang", " a web developer" ]'><span class="wrap"></span></a>
            <p>Based in Seoul, South Korea</p>
            <p>Open to opportunities in USA (Seattle, NYC, or Remote)</p>
        </div>
        <!-- <div class="tempLinks">
            <p>Projects</p>
